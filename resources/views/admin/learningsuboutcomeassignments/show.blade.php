...
@section('content')
    <div class="card mt-6">
        <div class="card-header flex flex-row justify-between">
            <h1 class="h6">Learning Suboutcome Assignment Details</h1>
        </div>

        <div class="card-body grid grid-cols-1 gap-6 lg:grid-cols-1">
            <div class="p-4">
                <ul class="list-disc list-inside">
                    <li><strong>Learning Suboutcome:</strong> {{ $learningSuboutcomeAssignment->learningSuboutcome->name }}</li>
                    <li><strong>Assignment:</strong> {{ $learningSuboutcomeAssignment->assignment->name }}</li>
                </ul>
            </div>
        </div>
    </div>
