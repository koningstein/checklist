            ...
            <x-slot name="body">
                @forelse($courses as $course)
                    <x-table.row>
                        ...
                        <x-table.cell class="w-1/12">
                            @can('edit course')
                                <a href="{{ route('admin.courses.edit', ['course' => $course->id]) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded flex items-center justify-center text-xs w-full">
                        ...
                        <x-table.cell class="w-1/12">
                            @can('delete course')
                                <a href="{{ route('admin.courses.delete', ['course' => $course->id]) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded flex items-center justify-center text-xs w-full">
                    ...
                    <x-table.row>
                        <x-table.cell colspan="5">
                            <div class="flex justify-center items-center">
                                <span class="font-medium py-8 text-gray-500 text-xl">Geen course gevonden...</span>
                            </div>
                        </x-table.cell>
                    </x-table.row>
                @endforelse
